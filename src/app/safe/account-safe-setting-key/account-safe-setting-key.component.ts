...
@Component({
  selector: 'app-account-safe-setting-key',
  templateUrl: './account-safe-setting-key.component.html',
  styleUrls: ['./account-safe-setting-key.component.scss']
})
export class AccountSafeSettingKeyComponent implements OnInit {
  ...
  arrayJoin() {
    if(this.passwordArray.length > 5) {
      ...
      this.router.navigate(['/account-safe/input-email']);
    }
